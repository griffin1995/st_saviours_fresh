          ...
          <div className="grid lg:grid-cols-3 gap-8"> */}
			...
			<section
				...
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
					...
					<div className='grid gap-6 md:grid-cols-2 lg:grid-cols-3'>
						{/* Event 1 */}
						<article className='group bg-white border border-gray-200  overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1'>
							...
							<div className='p-6'>
								...
								<div className='pt-4 border-t border-gray-200'>
									<Link
										href='/events'
										className='inline-flex items-center text-gold-600 hover:text-gold-700 font-bold'>
						...
						<article className='group bg-white border border-gray-200  overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1'>
							...
							<div className='p-6'>
								...
								<p className='text-slate-700 leading-relaxed mb-4 line-clamp-3'>
									Join us every Friday during Lent as we pray the Stations of the Cross
									together.
								</p>
								<div className='space-y-3 mb-4'>
									<div className='flex items-center space-x-2 text-sm'>
						...
						<article className='group bg-white border border-gray-200  overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1'>
							...
							<div className='p-6'>
								...
								<p className='text-slate-700 leading-relaxed mb-4 line-clamp-3'>
									Simple soup and bread followed by a reflection on the Sunday Gospel. A
									beautiful way to journey through Lent together.
								</p>
								<div className='space-y-3 mb-4'>
									<div className='flex items-center space-x-2 text-sm'>
										<Calendar className='h-4 w-4 text-gold-600' />
						...
						<article className='group bg-white border border-gray-200  overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1'>
							...
							<div className='p-6'>
								...
								<p className='text-slate-700 leading-relaxed mb-4 line-clamp-3'>
									Check back regularly for more parish events, activities, and
