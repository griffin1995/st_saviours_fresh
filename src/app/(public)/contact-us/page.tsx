...
export default function ContactUsPage() {
  return (
    <main>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {/* Phone Contact */}
            <div className="group bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-start space-x-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm font-semibold text-gold-600">Call during office hours</p>
                </div>
              </div>
              ...
              <div className="mb-4 pb-4 border-b border-gray-200">
                <p className="text-lg font-bold text-slate-900 mb-1">020 8852 3073</p>
            ...
            <div className="group bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-start space-x-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm font-semibold text-gold-600">Written inquiries</p>
                </div>
              </div>
              <p className="text-slate-700 leading-relaxed mb-4">
              ...
              <div className="mb-4 pb-4 border-b border-gray-200">
                <p className="text-sm font-bold text-slate-900 mb-1">lewisham@rcaos.org.uk</p>
            ...
            <div className="group bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-start space-x-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm font-semibold text-gold-600">Lewisham High Street</p>
                </div>
              </div>
              <p className="text-slate-700 leading-relaxed mb-4">
              ...
              <div className="mb-4 pb-4 border-b border-gray-200">
                <p className="text-sm font-bold text-slate-900 mb-1">Lewisham High Street</p>
            ...
            <div className="group bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-start space-x-4 mb-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-slate-900 mb-1">Pastoral Care</h3>
                  <p className="text-sm font-semibold text-gold-600">24/7 emergencies</p>
                </div>
              </div>
              <p className="text-slate-700 leading-relaxed mb-4">
              ...
              <div className="mb-4 pb-4 border-b border-gray-200">
                <p className="text-sm font-bold text-slate-900 mb-1">Emergency Line</p>
      ...
      {/* OFFICE HOURS & MASS TIMES SECTION */}
          ...
          <div className="grid lg:grid-cols-2 gap-16">
                  ...
                  <div key={index} className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="text-lg font-bold text-gold-600">{schedule.hours}</p>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div>
              <div className="mb-8">
                ...
                <p className="text-lg text-slate-700">
                  Regular Mass schedule throughout the week. Special liturgies during
                  holy seasons and feast days.
                </p>
              </div>
              ...
              <div className="bg-slate-900 rounded-lg p-6">
                <div className="space-y-4">
                  {[
                    { day: 'Sunday', times: ['8:30 AM', '10:00 AM', '11:30 AM', '5:30 PM'] },
                    { day: 'Weekdays', times: ['10:00 AM', '6:30 PM'] },
                    { day: 'Saturday', times: ['10:00 AM', '5:30 PM Vigil'] },
                  ].map((schedule, index) => (
                    <div key={index} className="border-l-4 border-gold-500 pl-4 py-2">
                      <h3 className="text-lg font-bold text-white mb-1">{schedule.day}</h3>
                      <div className="flex flex-wrap gap-2">
                        {schedule.times.map((time, timeIndex) => (
                          <span
                            key={timeIndex}
                            className="px-2 py-1 bg-gold-500/20 text-gold-300 rounded text-sm"
                          >
                            {time}
                          </span>
                        ))}
                ...
                <div className="mt-6 pt-6 border-t border-slate-700">
                  <Link
                    href="/mass"
                    className="inline-flex items-center text-gold-400 hover:text-gold-300 font-bold transition-colors"
                  >
                    View Full Schedule
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="relative">
              <div className="bg-slate-100 rounded-lg overflow-hidden shadow-lg aspect-square">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-2">Church Address</h3>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-2">Transport Links</h3>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg p-8 shadow-xl">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-4">Contact Form</h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="tel:02088523073"
                  className="inline-flex items-center justify-center px-6 py-3 bg-slate-900 text-white hover:bg-slate-800 font-semibold rounded-lg transition-colors duration-300"
                >
                ...
                <a
                  href="mailto:lewisham@rcaos.org.uk"
                  className="inline-flex items-center justify-center px-6 py-3 bg-gold-500 text-white hover:bg-gold-600 font-semibold rounded-lg transition-colors duration-300"
                >
