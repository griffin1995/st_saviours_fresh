...
const defaultImages = {
  ...
  pages: {
    ...
    "learning-hub": {
      url: "/images/inside-church-3-glass-windows.jpg",
      alt: "Learning Hub - Expand your Catholic knowledge and deepen your faith"
    },
    "prayer-hub": {
      url: "/images/open-bible-rosary.jpg",
  ...
  learningCategories: [
    {
      ...
      url: "/images/inside-church-3-glass-windows.jpg",
      alt: "Catholic Faith Foundations - Essential teachings and traditions"
    },
    {
      category: "liturgy-worship", 
      url: "/images/priest-taking-communion.jpg",
      alt: "Liturgy & Worship - Understanding Mass and sacraments"
    },
    {
      category: "scripture-study",
      url: "/images/open-bible-rosary.jpg",
      alt: "Scripture & Study - Biblical interpretation and theology"
    },
    {
      category: "spiritual-life",
      url: "/images/candles.jpg",
      alt: "Spiritual Life - Prayer, contemplation, and growing in holiness"
    },
    {
      category: "parish-life",
      url: "/images/hands-up-praising.jpg",
      alt: "Parish Life - Community involvement and ministries"
    },
    {
      category: "family-faith",
      url: "/images/painted-glass-jesus.jpg",
      alt: "Family & Faith - Raising children in faith and Catholic living"
    }
  ],
  prayers: [
    {
...
export function getPrayerImages() {
  const images = getCMSImages();
  return images.prayers;
}

// Get prayer category image
...
// Get prayer hub page image
export function getPrayerHubPageImage() {
  const images = getCMSImages();
  return images.pages["prayer-hub"];
}

// Get learning hub page image (referenced in prayer components)
export function getLearningHubPageImage() {
  const images = getCMSImages();
  return images.pages["learning-hub"];
}

// **LEARNING HUB IMAGE MANAGEMENT**
// CMS DATA SOURCE: Learning category specific images following CMS structure

// Get learning category images
export function getLearningCategoryImages() {
  const images = getCMSImages();
  return images.learningCategories;
}

// Get learning category image
export function getLearningCategoryImage(categorySlug: string) {
  const learningImages = getLearningCategoryImages();
  return learningImages.find(img => img.category === categorySlug);
}